...
import com.example.guesswhosingleplayer.databinding.ActivityMainBinding

class MainActivity : AppCompatActivity(),DialogSelectMonster.DialogSelectMonsterListener, DialogDecideTurn.DialogDecideTurnListener, DialogDuelTurn.DialogDuelTurnListener, DialogQCategory.DialogQCategoryListener{
    private var chronoRunning = false //Determina si el cronómetro esta corriendo
    private var player1 = Player()
    private var player2 = Player()
    private lateinit var superBinding: ActivityMainBinding
